...
export default function Header({ title, rightAction, showBack = false, backUrl = "/shikshoo/admin" }: HeaderProps) {
    ...
    <Box sx={{
      ...
      <Container maxWidth="xl">
        ...
        >
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/customers")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/orders")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/shop-sms-logs")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/broadcast-sms")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/settings")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
        ...
        >
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/reports")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/inventory")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/expenses")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/installments")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/installment-credits")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/expenses-statistics")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/returned-products")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/profit-loss")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
        ...
        >
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/best-selling")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/manufacturers")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/invoices")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
          ...
          <MenuItem
            onClick={() => handleMenuClick("/shikshoo/admin/categories")}
            sx={{
              color: "#fff",
              fontSize: "15px",
              padding: "12px 20px",
