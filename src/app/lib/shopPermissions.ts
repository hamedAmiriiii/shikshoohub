...
const ROUTE_PERMISSIONS: { prefix: string; keys: ShopPermissionKey[] }[] = [
  ...
  { prefix: "/admin/customer-club", keys: ["customers", "shop_sms"] },
  { prefix: "/admin/smart-club", keys: ["customers", "shop_sms"] },
  ...
  { prefix: "/admin/partners", keys: ["partners"] },
...
const FIRST_ALLOWED_PATHS: { path: string; keys: ShopPermissionKey[] }[] = [
  ...
  { path: "/admin/customer-club", keys: ["customers", "shop_sms"] },
  { path: "/admin/smart-club", keys: ["customers", "shop_sms"] },
  ...
  { path: "/admin/smart-review", keys: ["reports"] },
