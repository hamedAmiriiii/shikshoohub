...
const TABLE_LABELS: Record<string, string> = {
  ...
  installments: "اقساط",
  credits: "اعتبار",
  user_credit_grants: "اعطاهای اعتبار",
  files: "فایل‌ها",
  accounting_accounts: "کدینگ حساب",
  accounting_vouchers: "اسناد حسابداری",
  accounting_lines: "آرتیکل سند",
  formal_invoice_seller_profiles: "پروفایل فروشنده فاکتور رسمی",
  formal_invoice_buyer_profiles: "پروفایل خریدار فاکتور رسمی",
  oil_products: "کالاهای روغن",
  oil_visits: "بازدید تعویض روغن",
  oil_visit_items: "اقلام بازدید روغن",
  oil_reminder_sms: "پیامک یادآوری روغن",
  shop_campaigns: "کمپین‌های باشگاه",
  shop_campaign_logs: "لاگ کمپین",
  shop_daily_ticket_counters: "شمارنده فیش روزانه",
  shop_partners: "شرکا",
  purchase_debt_payments: "وصول نسیه",
};
