...
export const LANDING_PRODUCTS: LandingProduct[] = [
  ...
  },
  {
    ...
    desc: "نرم‌افزار کلاس آنلاین و اتاق جلسه یادینو — چند کلاس همزمان، پیام‌رسان و تخته تعاملی.",
    lead: "یادینو برای آموزش آنلاین: چند کلاس و جلسه همزمان، تا ۴ ویدئو، پیام‌رسان اختصاصی، اشتراک تصویر و تخته. ورود از مرورگر، بدون نصب سنگین.",
    items: [
      "پیام‌رسان اختصاصی",
      ...
      "تا ۴ ویدئو همزمان",
      "تا ۵۰۰ کاربر همزمان (بسته به پلن)",
      "ورود از مرورگر",
    ],
    loginUrl: LOGIN_URL,
    registerUrl: REGISTER_URL,
