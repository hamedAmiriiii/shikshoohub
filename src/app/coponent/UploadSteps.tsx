...
const UploadSteps = ({ onFinish }) => {
    ...
    const steps = [
        { id: "imgAT",       label: " تصویر کارت ملی" },
        { id: "imgShenasAt", label: " تصویر صفحه اول شناسنامه" },
        { id: "imgPersenAt", label: "تصویر عکس پرسنلی" },
        { id: "imgJavazAt",  label: "تصویر جواز کسب" },
    ];
