...
export default function SelectLang(props: any) {
    ...
    return (
        <Paper sx={{backgroundColor:'#21242b', border: 0, boxShadow: 0, width: 320, maxWidth: '100%' }}>
            <MenuList>
                <MenuItem onClick={() => {
                    ...
                    <ListItemText sx={{ color: '#ffffff' }}>U.K</ListItemText>
                    <Typography variant="body2" sx={{ color: '#ffffff' }}>
                        En
                    </Typography>
                </MenuItem>
                ...
                {/* <MenuItem onClick={() => {
                    ...
                    <ListItemText sx={{ color: '#ffffff' }}>ایران</ListItemText>
                    <Typography variant="body2" sx={{ color: '#ffffff' }}>
                        Fa
                    </Typography>
                </MenuItem>
                ...
                <MenuItem onClick={() => {
                    ...
                    <ListItemText sx={{ color: '#ffffff' }}>Germany</ListItemText>
                    <Typography variant="body2" sx={{ color: '#ffffff' }}>
                        Gr
                    </Typography>
                </MenuItem>
                ...
                <MenuItem onClick={() => {
                    ...
                    <ListItemText sx={{ color: '#ffffff' }}>العربیه</ListItemText>
                    <Typography variant="body2" sx={{ color: '#ffffff' }}>
                        Ar
                    </Typography>
                </MenuItem>
