...
const FA: Dict = {
  ...
  noOrdersForPhone: "سفارشی یافت نشد",
...
const EN: Dict = {
  ...
  noOrdersForPhone: "No orders found",
...
const AR: Dict = {
  ...
  noOrdersForPhone: "لم يتم العثور على طلبات",
  ...
  noOpenOrder: "لا يوجد طلب مفتوح لهذه الطاولة.",
